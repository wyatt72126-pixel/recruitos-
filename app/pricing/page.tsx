...
const FAQ = [
  {
    ...
    a: "Starter gives you recruiting structure — a profile, a checklist, general outreach templates, and monthly tips. It does not include personalized school matches or verified coach contacts. Premium adds all of that: 50 matched schools, verified contacts for your top 5 priority schools pulled from official staff pages, personalized outreach emails, and camp and junior day alerts.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. The demo shows you exactly what a RecruitOS profile looks like — with sample school recommendations, sample coach contact layout, and a sample outreach email — before you commit to any plan.",
  },
  {
    q: "Who is Premium for?",
    a: "Premium is for athletes who are ready to reach out to coaches and want a specific list of programs to contact. If you just want to get organized and learn the recruiting process first, Starter is a lower-cost way to do that.",
  },
];
      ...
      <section className="bg-white border-b border-gray-100 py-14 sm:py-20 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 text-lg">
            Start free, get organized with Starter, or get your full recruiting plan with Premium.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-6 items-start max-w-5xl mx-auto text-left">
          ...
          <div className="flex flex-col rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <p className="text-gray-500 text-sm mb-6 leading-relaxed">
              Preview how RecruitOS works with sample data.
            </p>
            ...
            <p className="text-xs text-gray-400 mb-6 leading-relaxed">
              Personalized school matches and verified coach contacts are included with Premium.
            </p>
            <Link
              href="/demo"
          ...
          <div className="flex flex-col rounded-3xl border border-brand-200 bg-white p-8 shadow-sm">
            ...
            <div className="flex items-baseline gap-1 mb-1">
              ...
              <span className="text-gray-500 font-medium">.99<span className="text-sm">/month</span></span>
            </div>
            <p className="text-gray-500 text-sm mb-6 leading-relaxed">
              For athletes who want recruiting structure before upgrading to full research.
            </p>
            <ul className="space-y-3 mb-6 flex-1">
            ...
            <p className="text-xs text-gray-400 mb-6 leading-relaxed">
              Does not include personalized school matches or verified coach contacts.
            </p>
            <Link
              href="/onboarding"
          ...
          {/* Premium */}
          <div className="relative flex flex-col rounded-3xl bg-brand-700 text-white p-8 shadow-xl ring-2 ring-brand-500 mt-4 md:mt-0">
            ...
            <div className="flex items-baseline gap-1 mb-1">
              ...
              <span className="text-blue-200 font-medium text-sm">/month</span>
            </div>
            <p className="text-blue-100 text-sm mb-6 leading-relaxed">
              For athletes ready for a real recruiting plan.
            </p>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  ["Athlete profile", "✓", "✓"],
                  ["Recruiting checklist", "✓", "✓"],
                  ["Outreach email templates", "General", "Personalized"],
                  ["Monthly updates", "Tips", "Strategy"],
                  ["Personalized school matches", "—", "50"],
                  ["Priority schools", "—", "5"],
                  ["Verified coach contacts per school", "—", "3+"],
                  ["Contacts from official staff pages", "—", "✓"],
                  ["Camp & junior day alerts", "—", "✓"],
                ].map(([feature, starter, premium]) => (
                  <tr key={feature}>
                    <td className="py-3 pr-4 text-gray-700">{feature}</td>
                    <td className={`py-3 px-4 text-center ${starter === "—" ? "text-gray-300" : "text-gray-600"}`}>{starter}</td>
                    <td className={`py-3 px-4 text-center font-semibold ${premium === "—" ? "text-gray-300" : "text-brand-700"}`}>{premium}</td>
                  </tr>
                ))}
              </tbody>
            </table>
